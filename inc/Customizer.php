		...
		public function wp_head() {
			...
			<style>
				...
				if ( class_exists( 'Easy_Digital_Downloads' ) ) {
					// primary buttons.
					echo '#edd-purchase-button, .edd-submit, [type="submit"].edd-submit, input.edd-submit.button.blue {
					...
					echo '#edd-purchase-button:hover, .edd-submit:hover, [type="submit"].edd-submit:hover, input.edd-submit.button.blue:hover {
