...
class Enqueue
{
	...
	**/
	public function enqueue_block_editor_assets()
	{
		...
		if ( get_theme_mod( 'conversions_google_fonts', true ) == true ) {
			...
			// Enqueue headings font
			$headings_font = get_theme_mod( 'conversions_headings_fonts', 'Roboto:400,400italic,700,700italic' );
			wp_register_style( 'conversions-gutenberg-heading-font', '//fonts.googleapis.com/css?family='. esc_html( $headings_font ).'&display=swap' );
			...
			if( $body_font === $headings_font ) {
				...
				wp_register_style( 'conversions-gutenberg-body-font', '//fonts.googleapis.com/css?family='. esc_html( $body_font ).'&display=swap' );
	...
	**/
	function wp_enqueue_scripts()
	{
		...
		// CSS
		$css_version = $theme_version . '.' . filemtime(get_template_directory() . '/build/theme.min.css');
		wp_enqueue_style( 'conversions-styles', get_template_directory_uri() . '/build/theme.min.css', array(), $css_version );
		wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/build/font-awesome.min.css', array(), '5.10.2' );
		// RTL
		if ( is_rtl() ) {
  			wp_enqueue_style( 'conversions-styles-rtl', get_template_directory_uri() . '/build/theme.rtl.min.css', array(), $css_version );
