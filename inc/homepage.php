...
class Homepage
{
		...
		<section class="c-clients">
			<div class="container-fluid">
				<div class="row">
					...
					<?php do_action( 'conversions_homepage_before_clients' ); ?>
					...
					<?php do_action( 'conversions_homepage_after_clients' ); ?>
		...
		<section class="c-features">
			<div class="container-fluid">
				<div class="row">
					...
					<?php do_action( 'conversions_homepage_after_features' ); ?>
	...
	**/
	public static function testimonials()
	{
		...
		if ( ! $conversions_testimonials_decoded )
			return;
		...
		<section class="c-testimonials">
			<div class="container-fluid">
				<div class="row">
					...
					<?php do_action( 'conversions_homepage_before_testimonials' ); ?>
					...
					<?php do_action( 'conversions_homepage_after_testimonials' ); ?>
		...
		<section class="c-news">
			<div class="container-fluid">
				<div class="row">
					...
					<?php do_action( 'conversions_homepage_after_news' ); ?>
