	...
	<section class="c-clients">
		<div class="container-fluid">
			<div class="row">
				...
				<?php do_action( 'conversions_homepage_after_client_logos' ); ?>
	...
	<section class="c-features">
		<div class="container-fluid">
			<div class="row">
				...
				<?php do_action( 'conversions_homepage_after_features_blocks' ); ?>
	...
	<section class="c-pricing">
		<div class="container-fluid">
			<div class="row">
				...
				<?php do_action( 'conversions_homepage_after_pricing_tables' ); ?>
	...
	<section class="c-news">
		<div class="container-fluid">
			<div class="row">
				...
				<?php do_action( 'conversions_homepage_after_news_posts' ); ?>
