...
if ( ! function_exists ( 'conversions_setup' ) ) {
	...
	function conversions_setup() {
		 ...
		 * If you're building a theme based on conversions, use a find and replace
		 * to change 'conversions' to the name of your theme in all the template files
		 */
		load_theme_textdomain( 'conversions', get_template_directory() . '/languages' );
