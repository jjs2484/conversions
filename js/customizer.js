...
jQuery(document).ready(function($) {
	...
	var $ctaBgImage = $( '#customize-control-conversions_hcta_bg_img, #customize-control-conversions_hcta_img_color_control, #customize-control-conversions_hcta_img_overlay' );
...
!(function (t) {
	...
	'//zx': function (t, e) {},
	0: function (t, e, n) {
		n('H0l3'), (t.exports = n('//zx'));
	},
	Asnn: function (t, e) {
		wp.customize.sectionConstructor['conversions-customizer-button'] = wp.customize.Section.extend({
