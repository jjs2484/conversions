...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		<noscript>
			...
			<br/><button type="submit" class="btn <?php esc_attr_e( get_theme_mod( 'conversions_wc_checkout_btn', 'btn-primary' ) ); ?>" name="woocommerce_checkout_update_totals" value="<?php esc_attr_e( 'Update totals', 'conversions' ); ?>"><?php esc_html_e( 'Update totals', 'conversions' ); ?></button>
		</noscript>
