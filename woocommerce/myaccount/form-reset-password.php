...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Enter a new password below.', 'conversions' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="btn <?php esc_attr( get_theme_mod( 'conversions_wc_primary_btn', 'btn-outline-primary' ) ); ?>" value="<?php esc_attr_e( 'Save', 'conversions' ); ?>"><?php esc_html_e( 'Save', 'conversions' ); ?></button>
	</p>
